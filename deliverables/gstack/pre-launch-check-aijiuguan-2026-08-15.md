...
| 11 | 🟡 P2 | 长对话虚拟化：现状 ChatMain 已有 P1-9 尾部窗口渲染（100 条 + 上滚增量 + 滚动补偿），局限为单向上、DOM 只增不减、无回收/跳转 | **分批计划已制定**：`deliverables/gstack/P2-11-virtualization-plan.md`（Phase 1 基线压测 → 2 方案选型 → 3 双向窗口核心 → 4 边界体验 → 5 压测验证 → 6 收尾） | 📋 计划待实施 |
